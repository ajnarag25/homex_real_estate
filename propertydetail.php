                                            ...
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>80% TCP Balance: <b><?php echo number_format($tcp80, 2, '.',',')  ?></b></p>
                                                        <table class="table">
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">Term</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>P <?php echo number_format($income_requirement_inhouse1, 2, '.',',') ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>3</th>
                                                                    <td>16.0%</td>
                                                                    ...
                                                                    <td>P <?php echo number_format($income_requirement_inhouse3, 2, '.',',') ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>5</th>
                                                                    <td>18.0%</td>
                                                                    ...
                                                                    <td>P <?php echo number_format($income_requirement_inhouse5, 2, '.',',') ?></td>
                                                                </tr>
                                                                <tr>
                                                                    <th>10</th>
                                                                    <td>20.0%</td>
                                                                    ...
                                                                    <td>P <?php echo number_format($income_requirement_inhouse10, 2, '.',',') ?></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <div class="modal-dialog modal-xl" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <?php if($reserve['tag_stat'] == 'Banking Finance'){ ?>
                                                        <h5>Estimated Monthly Amortization:</h5>
                                                        <p>(Based on Total less Discount) - <span class="text-primary">Bank Financing</span></p>
                                                        <table class="table">
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">Term</th>
                                                        ...
                                                        <?php } elseif($reserve['tag_stat'] == 'Pag-ibig Finance'){?>

                                                        <h5>Estimated Monthly Amortization:</h5>
                                                        <p>(Based on Total less Discount) - <span class="text-primary">Pag-ibig Financing</span></p>
                                                        ...
                                                        <?php } elseif($reserve['tag_stat'] == 'In House (Installment - Buyer)'){ ?>

                                                        <h5>Estimated Monthly Amortization:</h5>
                                                        <p>(Based on Total less Discount) - <span class="text-primary">In-House Financing</span></p>
                                                        <p>80% TCP Balance: <b><?php echo number_format($tcp80, 2, '.',',')  ?></b></p>
                                                        <table class="table">
                                                            <thead>
                                                                <tr>
