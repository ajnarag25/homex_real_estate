								...
								<div class="description">
									<h5 class="text-secondary">Basic Information</h5><hr>
										...
										<div class="row">
                                            ...
                                            <a href="feature.php" class="btn btn-danger" style="margin-left:200px;">Cancel</a>
											<input type="submit" value="Submit" class="btn btn-primary"name="addProperty" style="margin-left:200px;">
